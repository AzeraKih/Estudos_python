...
##
##Print the list of alternative numbers, using the slicing option, starting from
##'3'.
##Print the list of alternative numbers obtained from the first 4 elements only.
##Print the list of odd indexed elements of list 'k'. Since indexing starts at
##zero, odd indices would be 1,3, and so on.
